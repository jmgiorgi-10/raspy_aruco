...
TEST(common, TRAJECTORY)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::TRAJECTORY packet_in{};
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.type = 177;
    packet_in.point_1 = {{ 73.0, 74.0, 75.0, 76.0, 77.0, 78.0, 79.0, 80.0, 81.0, 82.0, 83.0 }};
    packet_in.point_2 = {{ 381.0, 382.0, 383.0, 384.0, 385.0, 386.0, 387.0, 388.0, 389.0, 390.0, 391.0 }};
    packet_in.point_3 = {{ 689.0, 690.0, 691.0, 692.0, 693.0, 694.0, 695.0, 696.0, 697.0, 698.0, 699.0 }};
    packet_in.point_4 = {{ 997.0, 998.0, 999.0, 1000.0, 1001.0, 1002.0, 1003.0, 1004.0, 1005.0, 1006.0, 1007.0 }};
    packet_in.point_5 = {{ 1305.0, 1306.0, 1307.0, 1308.0, 1309.0, 1310.0, 1311.0, 1312.0, 1313.0, 1314.0, 1315.0 }};
    packet_in.point_valid = {{ 244, 245, 246, 247, 248 }};

    mavlink::common::msg::TRAJECTORY packet1{};
    mavlink::common::msg::TRAJECTORY packet2{};
    ...
    EXPECT_EQ(packet1.time_usec, packet2.time_usec);
    EXPECT_EQ(packet1.type, packet2.type);
    EXPECT_EQ(packet1.point_1, packet2.point_1);
    EXPECT_EQ(packet1.point_2, packet2.point_2);
    EXPECT_EQ(packet1.point_3, packet2.point_3);
    EXPECT_EQ(packet1.point_4, packet2.point_4);
    EXPECT_EQ(packet1.point_5, packet2.point_5);
    EXPECT_EQ(packet1.point_valid, packet2.point_valid);
}

#ifdef TEST_INTEROP
TEST(common_interop, TRAJECTORY)
{
    mavlink_message_t msg;
    ...
    mavlink_msg_trajectory_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.time_usec, packet2.time_usec);
    EXPECT_EQ(packet_in.type, packet2.type);
    EXPECT_EQ(packet_in.point_1, packet2.point_1);
    EXPECT_EQ(packet_in.point_2, packet2.point_2);
    EXPECT_EQ(packet_in.point_3, packet2.point_3);
    EXPECT_EQ(packet_in.point_4, packet2.point_4);
    EXPECT_EQ(packet_in.point_5, packet2.point_5);
    EXPECT_EQ(packet_in.point_valid, packet2.point_valid);
