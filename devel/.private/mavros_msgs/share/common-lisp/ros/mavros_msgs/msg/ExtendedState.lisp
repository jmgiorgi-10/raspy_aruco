...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ExtendedState>)))
  ...
  (cl:format cl:nil "# Extended autopilot state~%#~%# http://mavlink.org/messages/common#EXTENDED_SYS_STATE~%~%uint8 VTOL_STATE_UNDEFINED = 0~%uint8 VTOL_STATE_TRANSITION_TO_FW = 1~%uint8 VTOL_STATE_TRANSITION_TO_MC = 2~%uint8 VTOL_STATE_MC = 3~%uint8 VTOL_STATE_FW = 4~%~%uint8 LANDED_STATE_UNDEFINED = 0~%uint8 LANDED_STATE_ON_GROUND = 1~%uint8 LANDED_STATE_IN_AIR = 2~%uint8 LANDED_STATE_TAKEOFF = 3~%uint8 LANDED_STATE_LANDING = 4~%~%std_msgs/Header header~%uint8 vtol_state~%uint8 landed_state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ExtendedState)))
  "Returns full string definition for message of type 'ExtendedState"
  (cl:format cl:nil "# Extended autopilot state~%#~%# http://mavlink.org/messages/common#EXTENDED_SYS_STATE~%~%uint8 VTOL_STATE_UNDEFINED = 0~%uint8 VTOL_STATE_TRANSITION_TO_FW = 1~%uint8 VTOL_STATE_TRANSITION_TO_MC = 2~%uint8 VTOL_STATE_MC = 3~%uint8 VTOL_STATE_FW = 4~%~%uint8 LANDED_STATE_UNDEFINED = 0~%uint8 LANDED_STATE_ON_GROUND = 1~%uint8 LANDED_STATE_IN_AIR = 2~%uint8 LANDED_STATE_TAKEOFF = 3~%uint8 LANDED_STATE_LANDING = 4~%~%std_msgs/Header header~%uint8 vtol_state~%uint8 landed_state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
